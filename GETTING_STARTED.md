...
- **OpenAI API Key** - [Get one here](https://platform.openai.com/api-keys)
  - Cost: ~$0.005-$0.02 per conversation with GPT-5 (cheaper than GPT-4!)
...
GPT-5       (Weather, Currency)
```

### The Magic: Function Calling

The assistant uses **GPT-5's function calling** to automatically decide when to use external APIs:

1. You ask: "What's the weather in Aspen?"
2. GPT-5 thinks: "I need real-time weather data"
3. GPT-5 calls: `get_weather("Aspen")`
4. Backend executes the Open-Meteo API call
5. GPT-5 receives data and formats a natural response
